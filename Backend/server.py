...
async def upload_image(file: UploadFile = File(...)):
    ...
    try:
        ...
        import traceback
        print(f"UPLOAD ERROR: {type(e).__name__}: {e!r}")
        traceback.print_exc()
...
async def get_info():
    ...
    ignore_words = ['sr', 'zrl', 'tumt', 'zr', 'cash', 'change', 'total', 'subtotal', 'gst', 'tax', 'amount', 'cashier', 'summary', 'payment', 'details', 'count', 'iten', 'tlrh', 'rm', 'funding', 'adjustment', 'rounding', 'rounded', 'desc', 'qty', 'price', 'disc']
    ...
    # Test
    price_array, items = process_receipt('rec.png')
    if items is None:
        print("Image of Receipt Needs To Be Better Quality. Please Try Again.")
    else:
        print(items)
